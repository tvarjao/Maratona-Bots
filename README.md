...
## Configuração do Bot Framework em ambiente Node
Fonte: https://github.com/CommunityBootcamp/Maratona-BOTs/blob/master/QuickStart/configurando-ambiente-nodejs.md
